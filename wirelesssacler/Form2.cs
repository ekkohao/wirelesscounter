...
namespace wirelesssacler
{
    public partial class Form2 : Form
    {
        ...
        private void deletedev_Click(object sender, EventArgs e)
        {
            ...
            //if (DG_List.Rows[nrow].Cells[0].Value == null) return;
            //deleteid = DG_List.Rows[nrow].Cells[0].Value.ToString();
            //if ( deleteid!="" || deleteid!=null)
            //  {
                 
            //      SqlHelp sql = new SqlHelp();
            //      string str = "delete from Dev_List where Dev_ID ='"+deleteid+"'";
            //      sql.Insert(str); 
            //     RefreshNow();
            //     if(ListLoad()==false)
            //     {
