...
using _CUSTOM_CONTROLS._ChatListBox2;

namespace _CUSTOM_CONTROLS
{
    public partial class ChatListBox2 : Control
    {
        public ChatListBox2() {
            InitializeComponent();
        ...
        public event ChatListEventHandler MouseUpSubItem;
        public event ChatListEventHandler MouseUpItem;  
        ...
        protected virtual void OnMouseUpSubItem(ChatListEventArgs e)
        {
            if (this.MouseUpSubItem != null)
                MouseUpSubItem(this, e);
        }
        protected virtual void OnMouseUpItem(ChatListEventArgs e)
        {
            if (this.MouseUpItem != null)
                MouseUpItem(this, e);
        }
        ...
        protected override void OnMouseUp(MouseEventArgs e) {
           ...
           if(selectSubItem!=null)
               OnMouseUpSubItem(new ChatListEventArgs(this.m_mouseOnSubItem, this.selectSubItem,e.Button));
           else if(selectItem!=null)
               OnMouseUpItem(new ChatListEventArgs(this.m_mouseOnSubItem, this.selectItem,e.Button));
            base.OnMouseUp(e);
        ...
        public class ChatListItemCollection : IList, ICollection, IEnumerable
        {
            ...
            private ChatListBox2 owner;  //所属的控件

            public ChatListItemCollection(ChatListBox2 owner) { this.owner = owner; }
            //确认存储空间
            ...
            public void Add(ChatListItem item) {
                ...
                if (-1 == this.IndexOf(item)) {         //进制添加重复对象
                    item.OwnerChatListBox2 = this.owner;
